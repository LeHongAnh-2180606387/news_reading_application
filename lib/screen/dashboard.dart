...
import 'package:news_reading_application/controller/news_controller.dart';
import 'package:news_reading_application/database/database_handler.dart';
import 'package:news_reading_application/widget/settings.dart';
import 'package:news_reading_application/widget/widget_components.dart';
                      ...
                      itemBuilder: (context, index) {
                        return GestureDetector(
                          onTap: () => Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => NewsPresenter(
                                      newsUrl: newsController.news[index].url
                                          .toString()))),
                          child: Card(
                            ...
                            child: ListTile(
                              ...
                              title: Text(
                                  newsController.news[index].title.toString(),
                              ...
                              subtitle: Column(
                                ...
                                children: [
                                  Text(
                                      newsController.news[index].author
                                          .toString(),
                                      style: GoogleFonts.abel(fontSize: 12)),
                                  Text(
                                      newsController.news[index].publishedAt
                                          .toString(),
                                      style: GoogleFonts.abel(fontSize: 12)),
                                ],
                              ),
                              trailing: IconButton(
                                  onPressed: () => DatabaseHandler()
                                      .addBookmark(
                                          context, newsController.news[index]),
  ...
  void setCategoryButtonIndicator(String indicator) {
    switch (indicator) {
      case "all":
        setState(() {
          all = true;
          business = national = entertainment = health = sports =
              technology = science = video = politics = socialMedia = false;
        });
      ...
      case "business":
        setState(() {
          business = true;
          all = national = entertainment = health = sports =
              technology = science = video = politics = socialMedia = false;
        });
        break;
      ...
      case "entertainment":
        setState(() {
          entertainment = true;
          all = business = national = health = sports =
              technology = science = video = politics = socialMedia = false;
        });
        break;
      ...
      case "health":
        setState(() {
          health = true;
          all = business = national = entertainment = sports =
              technology = science = video = politics = socialMedia = false;
        });
        break;
      ...
      case "sports":
        setState(() {
          sports = true;
          all = business = national = entertainment = health =
              technology = science = video = politics = socialMedia = false;
        });
        break;
      ...
      case "technology":
        setState(() {
          technology = true;
          all = business = national = entertainment = health =
              sports = science = video = politics = socialMedia = false;
        });
        break;
      ...
      case "science":
        setState(() {
          science = true;
          all = business = national = entertainment = health =
              sports = technology = video = politics = socialMedia = false;
        });
        break;
      ...
      case "video":
        setState(() {
          video = true;
          all = business = national = entertainment = health =
              sports = technology = science = politics = socialMedia = false;
        });
        break;
      ...
      case "social media":
        setState(() {
          socialMedia = true;
          all = business = national = entertainment =
              health = sports = technology = science = video = politics = false;
        });
      ...
      case "politics":
        setState(() {
          politics = true;
          all = business = national = entertainment = health =
              sports = technology = science = video = socialMedia = false;
        });
